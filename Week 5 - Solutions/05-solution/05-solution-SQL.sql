...
-- 18
CREATE TABLE NationalClubRankedIn (
       clubID INT,
       rankingID INT NOT NULL,
       _rank INT NOT NULL,
       PRIMARY KEY (clubID),
       FOREIGN KEY (clubID) REFERENCES Club(ID),
       FOREIGN KEY (rankingID) REFERENCES NationalClubRanking(ID)
);

-- 18
CREATE TABLE GlobalClubRankedIn (
       clubID INT,
       rankingID INT NOT NULL,
       _rank INT NOT NULL,
       PRIMARY KEY (clubID),
       FOREIGN KEY (clubID) REFERENCES Club(ID),
       FOREIGN KEY (rankingID) REFERENCES GlobalClubRanking(ID)
);
